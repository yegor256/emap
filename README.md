...
| | 4 | 16 | 256 |
| --- | --: | --: | --: |
| `i ∈ 0..CAP {M.insert(i, &"Hello, world!");}` |47.50 |99.83 |5.10 |
| `i ∈ 0..CAP {M.insert(i, &42); s ∈ M.into_values() {s > 0;};}` |1.12 |0.94 |0.78 |
| `i ∈ 0..CAP {M.insert(i, &42);} i ∈ CAP-1..0 {M.remove(&i);}` |51.25 |100.07 |5.02 |
